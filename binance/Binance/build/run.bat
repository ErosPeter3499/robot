...
javac -cp "C:/robot/binance/Binance/lib/json-20210307.jar" -d ../build C:/robot/binance/Binance/src/com/example/App.java
REM javac -d out src/com/example/App.java
javac -cp "C:/robot/binance/Binance/lib/json-20210307.jar" -d C:/robot/binance/Binance/build/out C:/robot/binance/Binance/src/com/example/App.java
...
cd /d c:\robot\binance\Binance\build

REM Run the compiled class
java -cp ".;../lib/json-20210307.jar" App
